...
class GalacticSwarmOptimization(object):
    ...
    def run_phase_1(self, subswarm_collection, WOA_list=None): # run PSO in subswarms independently
        ...
        if WOA_list is None:   # at epoch 1, PSO objects are created, at the end of each epoch,
                                # the states of each subswarm is saved and continued in next epoch
            WOA_list = []
            for i in range(self.m):
                subswarm_i = subswarm_collection[i]
                WOA_i = ModifiedWOA(dimension, n, subswarm_i, self.range0, self.range1, self.ep_max)
                gBest_collection[i], gBest_fitness_collection[i] = WOA_i.run()
                WOA_list.append(WOA_i)
        ...
        return gBest_collection, gBest_fitness_collection, WOA_list
    ...
    def run(self, subswarm_collection):
        ...
        for i in range(self.ep_max):
            ...
            print("start epoch {}................"
                  ".............................."
                  "..............................".format(i))
            gBest_collection, gBest_fitness_collection, WOA_list = GSO.run_phase_1(subswarm_collection, WOA_list)
